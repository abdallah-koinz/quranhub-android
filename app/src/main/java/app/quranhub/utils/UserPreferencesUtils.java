...
public final class UserPreferencesUtils {
    ...
    public static String getAppLangSetting(@NonNull Context context) {
        ...
        if (Constants.SUPPORTED_LANGUAGES.CODES.contains(LocaleUtils.getAppLanguage())) {
    ...
    public static int getRecitationSetting(@NonNull Context context) {
        return SharedPrefsUtils.getInteger(context, PREF_RECITATION_SETTING, Constants.RECITATIONS.HAFS_ID);
    }
